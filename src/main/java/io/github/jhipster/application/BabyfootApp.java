...
public class BabyfootApp {

    private static final Logger log = LoggerFactory.getLogger(BabyfootApp.class);

    private final Environment env;

    public BabyfootApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes babyfoot.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BabyfootApp.class);
